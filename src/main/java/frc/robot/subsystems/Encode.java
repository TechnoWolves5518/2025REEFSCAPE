...
public class Encode extends SubsystemBase {
  ...
  public Encode() {
    frontRight = new CANcoder(Constants.SwerveConstants.FRONT_RIGHT);
    frontLeft = new CANcoder(Constants.SwerveConstants.FRONT_LEFT);
    backRight = new CANcoder(Constants.SwerveConstants.BACK_RIGHT);
    backLeft = new CANcoder(Constants.SwerveConstants.BACK_LEFT);
  }
  public void read() {
